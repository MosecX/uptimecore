...
import { FaGithub } from "react-icons/fa"; // 👈 Importamos el ícono
      ...
      <div className="max-w-6xl mx-auto px-6 py-8 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <a
            ...
            className="flex items-center gap-2 px-3 py-1 rounded-lg bg-white/5 border border-white/10 text-gray-300 hover:text-white hover:bg-gray-800 hover:border-gray-500 transition-all font-medium shadow-sm"
          >
